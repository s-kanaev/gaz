...
reports_media_reason_adult="Материал для взрослых";
reports_media_reason_adult_description="Порнографический или эротический контент.";
reports_media_reason_animal_abuse="Жестокое обращение с животными";
...
reports_media_reason_bullying_calls="Призыв к травле";
...
reports_media_reason_cp="Детская порнография";
...
reports_media_reason_fake_news_description="Записи, намеренно вводящие в заблуждение для привлечения внимания или распространения дезинформации. ";
...
reports_media_reason_insult="Оскорбление";
...
reports_media_reason_weapons_selling="Продажа оружия";
...
reports_warning_sent="Ваша жалоба отправлена администрации сайта и будет рассмотрена в ближайшее время.";
